...
import random
import numpy as np
def generate_images(model_name, prompts_path, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=100, num_samples=10, from_case=0, till_case=1000000, base='1.4', random_seed = 42):
...
#     name = 'compvis-word_VanGogh-method_xattn-sg_3-ng_1-iter_1000-lr_1e-05'
    ...
    if model_name != 'original':
        print("yes")
        model_path = f'/mnt/bn/intern-disk/mlx/users/wrp/uce_nullspace/model_save/art_erase/500_preserve_1000_erase/object/{model_name}'
