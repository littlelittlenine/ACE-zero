...
from generate_images import generate_images, generate_images_1
...
if __name__ == '__main__':
    ...
    log_file_path = '/mlx_devbox/users/wangruipeng/playground/paper_run/uce_nullspace/unified-concept-editing-main/train_unbias/log_file_10.txt'  # 替换为您希望保存日志文件的路径
    # 打开文件以追加模式
    with open(log_file_path, 'a') as log_file:
        for i in tqdm(range(0, len(old_texts), batch_size)):
            ...
            counts_save = []
            for num_smallest_singular in range(5, 550, 5):
                P = get_project_input_3(ldm_stable, coco_path, num_smallest_singular=num_smallest_singular, batch_size=16)
                ...
                counts = CLIP_classification(im_path=img_path, attributes='a man,a woman', prompts_path='/mlx_devbox/users/wangruipeng/playground/paper_run/uce_nullspace/unified-concept-editing-main/data/profession/Analyst/analyst_origin.csv', save_path=None, from_case=0, till_case=10000)
